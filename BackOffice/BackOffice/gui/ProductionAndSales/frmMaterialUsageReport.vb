...
Public Class frmMaterialUsageReport
    ...
    Private Sub createDocument(doc As Document)
        ...
        documentTitle.AddText("Material Usage Report")
        ...
        For i As Integer = 0 To dtgrdList.RowCount - 1
            ...
            Dim uom As String = dtgrdList.Item(2, i).Value.ToString
    ...
    Private Function refreshList()
        ...
        Try
            ...
            If list <> "" Then
                query = "SELECT 
                    ...
                    FROM 
	                    `material_usage`
                    WHERE
                        `date` BETWEEN '" + dateStart.Text + "' AND '" + dateEnd.Text + "' AND `material_code` IN (" + list + ")
                    GROUP BY 
                        `material_code`
                    "
            ...
            While reader.Read
                ...
                Dim price As String = (New Material).getPrice(materialCode)
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnExportToPDF.Click
        ...
        document.Info.Title = "Material Usage Report"
        document.Info.Subject = "Material Usage Report"
        ...
        Dim filename As String = LSystem.getRoot & "\Material Usage Report " & dateStart.Text & dateEnd.Text & cmbCategory.Text & ".pdf"
    ...
    Private Sub btnExportToExcel_Click(sender As Object, e As EventArgs) Handles btnExportToExcel.Click
        ...
        Dim strFileName As String = LSystem.saveToDesktop & "\Material Usage Report " & dateStart.Text & dateEnd.Text & cmbCategory.Text & ".xls"
