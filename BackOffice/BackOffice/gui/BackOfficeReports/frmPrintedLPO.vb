...
Public Class frmPrintedLPO
    ...
    Private Function refreshList(filtered As Boolean)
        ...
        Try
            ...
            If filtered = True Then
                query = "SELECT `order_id`, `order_no`, `order_date`, `validity_period`, `valid_until`, `supplier_id`, `status`, `user_id` FROM `orders` WHERE `status`='PRINTED' AND `order_date` BETWEEN'" + dateStart.Text + "'AND'" + dateEnd.Text + "'"
            Else
                query = "SELECT `order_id`, `order_no`, `order_date`, `validity_period`, `valid_until`, `supplier_id`, `status`, `user_id` FROM `orders` WHERE `status`='PRINTED'"
            End If
            conn.Open()
    ...
    Private Sub btnClear_Click(sender As Object, e As EventArgs) Handles btnClear.Click
        clear()
    End Sub
    Private Sub frmPrintedLPO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Function print()
        ...
        document.Info.Title = "Printed LPO"
        document.Info.Subject = "Printed LPO"
        ...
        Dim filename As String = LSystem.getRoot & "\Printed LPO " & dateStart.Text & " to " & dateEnd.Text & " .pdf"
    ...
    Private Sub createDocument(doc As Document)
        ...
        documentTitle.AddText("Printed LPO")
