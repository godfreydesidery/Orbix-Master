...
Public Class frmPrintedLPO
    ...
    Private Function refreshList(filtered As Boolean)
        ...
        Try
            ...
            response = Web.get_("lpos/get_printed_lpos?from_date=" + dateStart.Text + "&to_date=" + dateEnd.Text + "&supplier_name=")

            Dim details As List(Of PrintedLPO) = JsonConvert.DeserializeObject(Of List(Of PrintedLPO))(response.ToString)
