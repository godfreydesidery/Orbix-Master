...
Public Class frmPriceChange
    ...
    Private Sub createDocument(doc As Document)
        ...
        documentTitle.AddText("Price change Report")
        ...
        row.Cells(1).AddParagraph("Date Time")
        row.Cells(1).Format.Alignment = ParagraphAlignment.Left
        row.Cells(2).AddParagraph("Item Code")
        row.Cells(2).Format.Alignment = ParagraphAlignment.Left
        row.Cells(3).AddParagraph("Description")
        row.Cells(3).Format.Alignment = ParagraphAlignment.Left
        row.Cells(4).AddParagraph("Old Price")
        row.Cells(4).Format.Alignment = ParagraphAlignment.Left
        row.Cells(5).AddParagraph("New Price")
        row.Cells(5).Format.Alignment = ParagraphAlignment.Left
        row.Cells(6).AddParagraph("Change")
        row.Cells(6).Format.Alignment = ParagraphAlignment.Left
        row.Cells(7).AddParagraph("User")
        row.Cells(7).Format.Alignment = ParagraphAlignment.Left
        row.Cells(8).AddParagraph("Reason")
        ...
        For i As Integer = 0 To dtgrdList.RowCount - 1
            ...
            Dim _date As String = dtgrdList.Item(0, i).Value
            Dim dateTime As String = dtgrdList.Item(1, i).Value
            Dim itemCode As String = dtgrdList.Item(2, i).Value
            Dim description As String = dtgrdList.Item(3, i).Value
            Dim oldPrice As String = dtgrdList.Item(4, i).Value
            Dim newPrice As String = dtgrdList.Item(5, i).Value
            Dim change As String = dtgrdList.Item(6, i).Value
            Dim user As String = dtgrdList.Item(7, i).Value
            Dim reason As String = dtgrdList.Item(8, i).Value
            ...
            row.Cells(0).Format.Alignment = ParagraphAlignment.Left
            row.Cells(1).AddParagraph(dateTime)
            row.Cells(1).Format.Alignment = ParagraphAlignment.Left
            row.Cells(2).AddParagraph(itemCode)
            row.Cells(2).Format.Alignment = ParagraphAlignment.Left
            row.Cells(3).AddParagraph(description)
            row.Cells(3).Format.Alignment = ParagraphAlignment.Left
            row.Cells(4).AddParagraph(oldPrice)
            row.Cells(4).Format.Alignment = ParagraphAlignment.Right
            row.Cells(5).AddParagraph(newPrice)
