...
Public Class frmSlowMovingItems
    ...
    Private Sub createDocument(doc As Document)
        ...
        documentTitle.AddText("Slow moving items")
    ...
    Private Function refreshList()
        ...
        Try
            ...
            response = Web.get_("sales/get_slow_moving_items?from_date=" + dateStart.Text + "&to_date=" + dateEnd.Text + "&supplier_name=&department_name=&class_name=&sub_class_name=")
