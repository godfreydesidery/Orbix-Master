...
Public Class frmPurchaseOrder
    ...
    Private Sub createDocument(doc As Document)
        ...
        paragraph.Format.Font.Size = 8
        paragraph = section.AddParagraph()
        paragraph.AddFormattedText("Order Date:  " + dateIssueDate.Text)
        paragraph.Format.Font.Size = 8
        paragraph = section.AddParagraph()
        paragraph.AddFormattedText("Valid Up To: " + dateValidUntil.Text)
        paragraph.Format.Font.Size = 8
        paragraph = section.AddParagraph()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        ...
        If txtId.Text <> "" Then
            Exit Sub
        End If
        If searchSupplier(txtSupplierCode.Text, cmbSupplier.Text) = True Then
