...
public class AuthServiceController {
    ...
    //Authorize a user
    @RequestMapping(value = "/users/authorize", produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    public boolean authorizeUser(@RequestParam(name = "user_id") Long user_id, @RequestParam(name = "priveledge") String priveledge) {     	    	
